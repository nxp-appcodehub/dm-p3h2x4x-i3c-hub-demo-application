 ...
 * Types
 ******************************************************************************/
#define I3C_COUNT (sizeof(i3cBases) / sizeof(void *))
...
#else
I3C_Type *const i3cBases[] = I3C_BASE_PTRS;
#endif
volatile bool b_I2C_CompletionFlag[I3C_COUNT] = {false};
volatile uint32_t g_I2C_ErrorEvent[I3C_COUNT] = {ARM_I3C_EVENT_TRANSFER_DONE};
