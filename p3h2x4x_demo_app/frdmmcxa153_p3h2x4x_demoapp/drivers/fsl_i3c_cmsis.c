...
static int32_t I3C_InterruptPowerControl(ARM_POWER_STATE state, cmsis_lpi2c_interrupt_driver_state_t *lpi2c)
{
    ...
    switch (state)
    {
        ...
        case ARM_POWER_FULL:
            ...
            I3C_MasterInit(lpi2c->resource->base, &masterConfig, I3C_MASTER_CLOCK_FREQUENCY);
...
static cmsis_lpi2c_resource_t LPI2C2_Resource = {EXAMPLE_MASTER, CLOCK_GetI3CFClkFreq};
