 ...
 * instance. */
#define RTE_I3C        1
// RTE_I3C_DMA_EN - 1 for EDMA Mode, 0 - for Interrupt Mode
...
#define RTE_I3C_DMA_TX_CH       0
#define RTE_I3C_DMA_TX_PERI_SEL (uint16_t) kDma0RequestMuxLpFlexcomm2Tx
#define RTE_I3C_DMA_TX_DMA_BASE DMA0
#define RTE_I3C_DMA_RX_CH       1
#define RTE_I3C_DMA_RX_PERI_SEL (uint16_t) kDma0RequestMuxLpFlexcomm2Rx
