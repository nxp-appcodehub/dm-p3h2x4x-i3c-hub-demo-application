...
- PCF2131 RTC DEVICE (optional for testing external device)
- P3T1755TP Temperature sensor (optional for testing external device)
- Personal Computer
...
2.  To test I3C hub with FRDM-MCXA153, P3H2x4x need to be connected using jumper wires with the baseboard.
